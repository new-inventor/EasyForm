...
class TypeCheckerTest extends PHPUnit_Framework_TestCase
{
    public function testCheck()
    {
        ...
        $this->assertTrue($typeChecker->check(new Object(), [SimpleTypes::OBJ])->result());
        ...
        $this->assertFalse($typeChecker->check(new Object(), [SimpleTypes::FLOAT])->result());
        ...
        $this->assertTrue($typeChecker->check(new Object(), [Object::getClass()])->result());
    ...
    public function testCheckArray()
    {
        ...
        $this->assertFalse(TypeChecker::getInstance()->checkArray(['qwe', 'qwe', '12312' => ['sdsasdasd'], new Object()], [SimpleTypes::STRING, SimpleTypes::ARR])->result());
    }
}
